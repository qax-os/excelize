...
var supportedFontWidthFactors = map[string]float64{
	...
	"arial black":                    1.20,
	"arial narrow":                   0.85,
	"arial rounded mt bold":          1.12,
	"arial unicode ms":               1.07,
	"arial":                          1.07,
	"bahnschrift":                    0.95,
	"baskerville old face":           0.93,
	"batang":                         1.05,
	"batangche":                      1.10,
	"bauhaus 93":                     1.05,
	"bell mt":                        0.90,
	"berlin sans fb":                 0.98,
	"bernard mt condensed":           0.78,
	"blackadder itc":                 0.95,
	"bodoni mt condensed":            0.75,
	"bodoni mt poster compressed":    0.68,
	"bodoni mt":                      0.88,
	"book antiqua":                   0.97,
	"bookman old style":              1.08,
	"broadway":                       1.15,
	"brush script mt":                0.78,
	"calibri light":                  0.98,
	"calisto mt":                     0.98,
	"cambria math":                   1.02,
	"cambria":                        1.02,
	"candara light":                  0.98,
	"cascadia mono extralight":       1.2,
	"castellar":                      1.2,
	"centaur":                        0.88,
	"century gothic":                 1.12,
	"century schoolbook":             1.05,
	"century":                        1.03,
	"chiller":                        0.85,
	"colonna mt":                     0.82,
	"comic sans ms":                  1.09,
	"consolas":                       1.1,
	"cooper black":                   1.22,
	"copperplate gothic bold":        1.25,
	"copperplate gothic light":       1.2,
	"corbel light":                   0.96,
	"corbel":                         0.98,
	"courier new":                    1.22,
	"curlz mt":                       1.1,
	...
	"dubai":                          0.95,
	"ebrima":                         0.98,
	"edwardian script itc":           0.78,
	"elephant":                       1.18,
	"engravers mt":                   1.2,
	"eras bold itc":                  1.08,
	"eras demi itc":                  1.05,
	"eras light itc":                 1.02,
	"eras medium itc":                1.05,
	"fangsong_gb2312":                1.05,
	"felix titling":                  1.15,
	"footlight mt light":             0.97,
	"forte":                          0.88,
	"franklin gothic demi cond":      0.85,
	"franklin gothic demi":           1.03,
	"franklin gothic heavy":          1.1,
	"franklin gothic medium":         1.03,
	"freestyle script":               0.82,
	"french script mt":               0.78,
	"fzshuti":                        1.05,
	"fzyaoti":                        1.05,
	"gabriola":                       0.9,
	"garamond":                       0.88,
	"georgia":                        1.03,
	"gigi":                           0.9,
	"gill sans mt condensed":         0.82,
	"gill sans mt":                   0.97,
	"gill sans ultra bold":           1.22,
	"gloucester mt extra condensed":  0.68,
	"goudy old style":                0.93,
	"goudy stout":                    2.25,
	"gulim":                          1.05,
	"gulimche":                       1.1,
	"gungsuh":                        1.05,
	"gungsuhche":                     1.1,
	"haettenschweiler":               0.68,
	"harlow solid italic":            0.85,
	"harrington":                     1.02,
	"helvetica neue":                 1.05,
	"helvetica":                      1.07,
	"high tower text":                0.82,
	"impact":                         0.88,
	"informal roman":                 1.02,
	"ink free":                       0.92,
	"javanese text":                  1.05,
	...
	"kokila":                         0.92,
	"kristen itc":                    1.05,
	"kunstler script":                0.68,
	"latha":                          0.9,
	"leelawadee ui":                  0.98,
	"leelawadee":                     0.98,
	"lisu":                           1.05,
	"lucida bright":                  1.12,
	"lucida calligraphy":             1.12,
	"lucida console":                 1.2,
	"lucida fax":                     1.08,
	"lucida handwriting":             1.12,
	"lucida sans typewriter":         1.2,
	"lucida sans unicode":            1.11,
	"lucida sans":                    1.11,
	"lxgw wenkai":                    1.05,
	"magneto":                        1.12,
	"maiandra gd":                    1.05,
	"malgun gothic semilight":        1.03,
	"malgun gothic":                  1.05,
	"mangal":                         1.05,
	"meiryo":                         1.05,
	"microsoft himalaya":             0.8,
	"microsoft jhenghei light":       1.03,
	"microsoft jhenghei ui":          1.05,
	"microsoft jhenghei":             1.05,
	"microsoft new tai lue":          0.98,
	"microsoft phagspa":              0.95,
	"microsoft sans serif":           1.07,
	"microsoft tai le":               0.95,
	"microsoft uighur":               0.85,
	"microsoft yahei light":          1.03,
	"microsoft yahei ui":             1.05,
	"microsoft yahei":                1.05,
	"microsoft yi baiti":             0.95,
	"mingliu_hkscs":                  1.05,
	"mingliu-extb":                   1.05,
	"mingliu":                        1.05,
	"mistral":                        0.82,
	"modern no. 20":                  0.85,
	"mongolian baiti":                0.9,
	"monotype corsiva":               0.8,
	"ms gothic":                      1.1,
	"ms pgothic":                     1.05,
	"ms reference sans serif":        1.12,
	"ms sans serif":                  1.05,
	"narkisim":                       0.88,
	"niagara engraved":               0.65,
	"niagara solid":                  0.65,
	"nirmala ui semilight":           0.96,
	"nirmala ui":                     0.98,
	"noto sans cjk":                  1.05,
	"noto serif cjk":                 1.05,
	"nsimsun":                        1.1,
	"nyala":                          0.95,
	"onyx":                           0.65,
	"palace script mt":               0.68,
	"palatino linotype":              0.97,
	"papyrus":                        1.05,
	"parchment":                      0.7,
	"perpetua titling mt":            1.1,
	"perpetua":                       0.9,
	"playbill":                       0.68,
	"poor richard":                   0.92,
	"pristina":                       0.82,
	"rage italic":                    0.78,
	"ravie":                          1.35,
	"rockwell condensed":             0.85,
	"rockwell extra bold":            1.15,
	"rockwell":                       1.05,
	"rod":                            0.88,
	"sakkal majalla":                 0.85,
	"sarasa gothic":                  1.05,
	...
	"segoe ui black":                 1.12,
	"segoe ui emoji":                 1.02,
	"segoe ui historic":              1.02,
	"segoe ui semibold":              1.04,
	"segoe ui semilight":             1.01,
	"segoe ui symbol":                1.02,
	"segoe ui":                       1.02,
	"shonar bangla":                  0.95,
	"showcard gothic":                1.25,
	"shruti":                         0.92,
	"simfang":                        1.05,
	"simhei":                         1.05,
	"simkai":                         1.05,
	...
	"sitka heading":                  0.97,
	"sitka small":                    1.02,
	"sitka subheading":               0.98,
	"snap itc":                       1.25,
	"source han sans":                1.05,
	"source han serif":               1.05,
	"stcaiyun":                       1.05,
	"stencil":                        1.1,
	"stfangsong":                     1.05,
	"stheiti":                        1.05,
	...
	"sylfaen":                        0.97,
	"tahoma":                         1.05,
	"tempus sans itc":                1.08,
	"times new roman":                0.92,
	"traditional arabic":             0.8,
	"trebuchet ms":                   1.02,
	"tunga":                          0.9,
	"tw cen mt condensed extra bold": 0.85,
	"tw cen mt condensed":            0.82,
	"tw cen mt":                      0.93,
	"ud digi kyokasho n-b":           1.05,
	"ud digi kyokasho n-r":           1.05,
	"ud digi kyokasho nk-b":          1.05,
	"ud digi kyokasho nk-r":          1.05,
	"ud デジタル 教科書体 n":                 1.05,
	"ud デジタル 教科書体 nk":                1.05,
	"urdu typesetting":               0.78,
	"utsaah":                         0.88,
	"vani":                           0.92,
	"verdana":                        1.21,
	"vijaya":                         0.85,
	"vivaldi":                        0.72,
	"vladimir script":                0.78,
	"vrinda":                         0.9,
	"wide latin":                     1.6,
	"youyuan":                        1.05,
	"yu gothic light":                1.01,
	"yu gothic medium":               1.04,
	"yu gothic ui light":             1.01,
	"yu gothic ui semibold":          1.05,
	"yu gothic ui semilight":         1.02,
	"yu gothic ui":                   1.03,
	"yu gothic":                      1.03,
	"yu mincho":                      1.03,
	"굴림":                             1.05,

...
var supportedFontWidthFactors = map[string][]float64{
	...
	"colonna mt":                     {0.87, 1.40, 1.00},
	"comic sans ms":                  {1.14, 1.46, 1.00},
	"consolas":                       {1.21, 1.19, 1.00},
	...
	"courier new":                    {1.31, 1.28, 1.00},
	"curlz mt":                       {1.16, 1.47, 1.00},
	"david":                          {0.95, 1.28, 1.00},
	"dengxian light":                 {1.02, 1.26, 1.02},
	"dengxian":                       {1.05, 1.28, 1.05},
	"dfkai-sb":                       {1.10, 1.10, 1.10},
	"dotum":                          {0.99, 1.31, 0.99},
	...
	"garamond":                       {0.96, 1.39, 1.00},
	"georgia":                        {1.09, 1.43, 1.00},
	"gigi":                           {0.95, 1.28, 1.00},
	...
	"narkisim":                       {0.93, 1.25, 1.00},
	"niagara engraved":               {0.48, 0.58, 1.00},
	...
	"ravie":                          {1.42, 1.86, 1.00},
	"rockwell condensed":             {0.90, 1.22, 1.00},
	"rockwell extra bold":            {1.22, 1.72, 1.00},
	"rockwell":                       {1.16, 1.48, 1.00},
	"rod":                            {0.93, 1.25, 1.00},
	"sakkal majalla":                 {0.90, 1.22, 1.00},
	...
	"tahoma":                         {1.07, 1.30, 1.00},
	"tempus sans itc":                {1.14, 1.46, 1.00},
	"times new roman":                {1.01, 1.40, 1.00},
	"traditional arabic":             {0.85, 1.56, 1.00},
	"trebuchet ms":                   {1.10, 1.26, 1.00},
	"tunga":                          {0.95, 1.28, 1.00},
	"tw cen mt condensed extra bold": {0.88, 1.22, 1.00},
	"tw cen mt condensed":            {0.86, 1.18, 1.00},
	"tw cen mt":                      {0.98, 1.32, 1.00},
	"ud digi kyokasho n-b":           {1.10, 1.36, 1.10},
	"ud digi kyokasho n-r":           {1.10, 1.36, 1.10},
	"ud digi kyokasho nk-b":          {1.10, 1.36, 1.10},
	"ud digi kyokasho nk-r":          {1.10, 1.36, 1.10},
	"ud デジタル 教科書体 n":                 {1.10, 1.36, 1.10},
	"ud デジタル 教科書体 nk":                {1.10, 1.36, 1.10},
	"urdu typesetting":               {0.82, 1.34, 1.00},
	"utsaah":                         {0.93, 1.25, 1.00},
	"vani":                           {0.97, 1.30, 1.00},
	"verdana":                        {1.23, 1.44, 1.00},
	"vijaya":                         {0.90, 1.22, 1.00},
	"vivaldi":                        {0.76, 2.12, 1.00},
	"vladimir script":                {0.82, 1.54, 1.00},
	"vrinda":                         {0.95, 1.28, 1.00},
	"wide latin":                     {1.68, 2.65, 1.00},
	"youyuan":                        {1.10, 1.36, 1.10},

...
// font families relative to Calibri. This is used for more accurate column
// width calculation when different font families are used.
var supportedFontWidthFactors = map[string][]float64{
	"calibri":                        {1, 1},
	"agency fb":                      {0.85, 0.98},
	"algerian":                       {1.20, 1.35},
	"aptos":                          {1.03, 1.17},
	"arial black":                    {1.35, 1.39},
	"arial narrow":                   {0.88, 1},
	"arial rounded mt bold":          {1.07, 1.22},
	"arial unicode ms":               {1.07, 1.22},
	"arial":                          {1.07, 1.22},
	"bahnschrift":                    {1.10, 1.10},
	"baskerville old face":           {0.98, 1.17},
	"batang":                         {0.99, 1.11},
	"batangche":                      {1.10, 0.90},
	"bauhaus 93":                     {1.10, 1.23},
	"bell mt":                        {0.95, 1.13},
	"berlin sans fb":                 {1.03, 1.16},
	"bernard mt condensed":           {0.82, 0.94},
	"blackadder itc":                 {1, 1.12},
	"bodoni mt condensed":            {0.82, 0.97},
	"bodoni mt poster compressed":    {0.72, 0.86},
	"bodoni mt":                      {1.06, 1.27},
	"book antiqua":                   {1.12, 1.24},
	"bookman old style":              {1.14, 1.26},
	"broadway":                       {1.20, 1.35},
	"brush script mt":                {0.82, 0.94},
	"calibri light":                  {0.98, 0.99},
	"calisto mt":                     {1.03, 1.22},
	"cambria math":                   {1.07, 1.08},
	"cambria":                        {1.07, 1.08},
	"candara light":                  {1.02, 1.15},
	"cascadia mono extralight":       {1.32, 1.09},
	"castellar":                      {1.26, 1.38},
	"centaur":                        {0.93, 1.10},
	"century gothic":                 {1.19, 1.16},
	"century schoolbook":             {1.10, 1.23},
	"century":                        {1.09, 1.22},
	"chiller":                        {0.90, 1.02},
	"colonna mt":                     {0.87, 1},
	"comic sans ms":                  {1.14, 1.26},
	"consolas":                       {1.21, 0.99},
	"cooper black":                   {1.28, 1.40},
	"copperplate gothic bold":        {1.32, 1.42},
	"copperplate gothic light":       {1.26, 1.38},
	"corbel light":                   {0.98, 1.06},
	"corbel":                         {1.03, 1.10},
	"courier new":                    {1.31, 1.08},
	"curlz mt":                       {1.16, 1.27},
	"david":                          {0.95, 1.08},
	"dengxian light":                 {1.02, 1.06},
	"dengxian":                       {1.05, 1.08},
	"dfkai-sb":                       {1.10, 0.90},
	"dotum":                          {0.99, 1.11},
	"dotumche":                       {1.10, 0.90},
	"dubai":                          {1, 1.12},
	"ebrima":                         {1.08, 1.11},
	"edwardian script itc":           {0.82, 0.94},
	"elephant":                       {1.24, 1.36},
	"engravers mt":                   {1.26, 1.38},
	"eras bold itc":                  {1.14, 1.25},
	"eras demi itc":                  {1.10, 1.22},
	"eras light itc":                 {1.07, 1.20},
	"eras medium itc":                {1.10, 1.22},
	"fangsong_gb2312":                {1.10, 0.90},
	"felix titling":                  {1.20, 1.35},
	"footlight mt light":             {1.03, 1.17},
	"forte":                          {0.93, 1.05},
	"franklin gothic demi cond":      {0.88, 1},
	"franklin gothic demi":           {1.08, 1.22},
	"franklin gothic heavy":          {1.16, 1.25},
	"franklin gothic medium":         {1.08, 1.22},
	"freestyle script":               {0.87, 0.98},
	"french script mt":               {0.82, 0.94},
	"fzshuti":                        {1.10, 0.90},
	"fzyaoti":                        {1.10, 0.90},
	"gabriola":                       {0.95, 1.08},
	"garamond":                       {0.96, 1.19},
	"georgia":                        {1.09, 1.23},
	"gigi":                           {0.95, 1.08},
	"gill sans mt condensed":         {0.85, 0.98},
	"gill sans mt":                   {1.03, 1.16},
	"gill sans ultra bold":           {1.30, 1.40},
	"gloucester mt extra condensed":  {0.72, 0.82},
	"goudy old style":                {0.98, 1.17},
	"goudy stout":                    {2.36, 2.60},
	"gulim":                          {0.99, 1.11},
	"gulimche":                       {1.10, 0.90},
	"gungsuh":                        {0.99, 1.11},
	"gungsuhche":                     {1.10, 0.90},
	"haettenschweiler":               {0.72, 0.82},
	"harlow solid italic":            {0.90, 1.02},
	"harrington":                     {1.07, 1.20},
	"helvetica neue":                 {1.10, 1.22},
	"helvetica":                      {1.07, 1.22},
	"high tower text":                {0.87, 1.03},
	"impact":                         {1.01, 0.92},
	"informal roman":                 {1.07, 1.20},
	"ink free":                       {1.02, 1.13},
	"javanese text":                  {1.10, 1.22},
	"jokerman":                       {1.16, 1.27},
	"juice itc":                      {0.82, 0.94},
	"kaiti_gb2312":                   {1.10, 0.90},
	"kaiti":                          {1.10, 0.90},
	"kartika":                        {1, 1.12},
	"kokila":                         {0.97, 1.10},
	"kristen itc":                    {1.10, 1.22},
	"kunstler script":                {0.72, 0.82},
	"latha":                          {0.95, 1.08},
	"leelawadee ui":                  {1.08, 1.11},
	"leelawadee":                     {1.03, 1.16},
	"lisu":                           {1.10, 1.22},
	"lucida bright":                  {1.18, 1.27},
	"lucida calligraphy":             {1.18, 1.27},
	"lucida console":                 {1.32, 1.09},
	"lucida fax":                     {1.14, 1.25},
	"lucida handwriting":             {1.25, 1.27},
	"lucida sans typewriter":         {1.32, 1.09},
	"lucida sans unicode":            {1.18, 1.27},
	"lucida sans":                    {1.18, 1.27},
	"lxgw wenkai":                    {1.10, 0.90},
	"magneto":                        {1.18, 1.30},
	"maiandra gd":                    {1.10, 1.22},
	"malgun gothic semilight":        {1.07, 1.11},
	"malgun gothic":                  {1.10, 1.13},
	"mangal":                         {1.10, 1.22},
	"meiryo":                         {1.19, 1.22},
	"microsoft himalaya":             {0.85, 0.96},
	"microsoft jhenghei light":       {1.10, 1.15},
	"microsoft jhenghei ui":          {1.16, 1.19},
	"microsoft jhenghei":             {1.16, 1.19},
	"microsoft new tai lue":          {1.03, 1.18},
	"microsoft phagspa":              {1, 1.12},
	"microsoft sans serif":           {1.07, 1.22},
	"microsoft tai le":               {1, 1.12},
	"microsoft uighur":               {0.90, 0.98},
	"microsoft yahei light":          {1.10, 1.15},
	"microsoft yahei ui":             {1.18, 1.20},
	"microsoft yahei":                {1.18, 1.20},
	"microsoft yi baiti":             {1, 1.12},
	"mingliu_hkscs":                  {1.10, 0.90},
	"mingliu-extb":                   {1.10, 0.90},
	"mingliu":                        {1.10, 0.90},
	"mistral":                        {0.87, 0.98},
	"modern no. 20":                  {0.90, 1.02},
	"mongolian baiti":                {0.95, 1.08},
	"monotype corsiva":               {0.85, 0.96},
	"ms gothic":                      {1.10, 0.90},
	"ms pgothic":                     {0.99, 1.11},
	"ms reference sans serif":        {1.18, 1.27},
	"ms sans serif":                  {1.10, 1.22},
	"narkisim":                       {0.93, 1.05},
	"niagara engraved":               {0.68, 0.78},
	"niagara solid":                  {0.68, 0.78},
	"nirmala ui semilight":           {1.01, 1.12},
	"nirmala ui":                     {1.03, 1.16},
	"noto sans cjk":                  {1.10, 1.13},
	"noto serif cjk":                 {1.10, 1.13},
	"nsimsun":                        {1.10, 0.90},
	"nyala":                          {1, 1.12},
	"onyx":                           {0.68, 0.78},
	"palace script mt":               {0.72, 0.82},
	"palatino linotype":              {1.12, 1.24},
	"papyrus":                        {1.10, 1.22},
	"parchment":                      {0.74, 0.84},
	"perpetua titling mt":            {1.16, 1.32},
	"perpetua":                       {0.95, 1.13},
	"playbill":                       {0.72, 0.82},
	"poor richard":                   {0.97, 1.16},
	"pristina":                       {0.87, 0.98},
	"rage italic":                    {0.82, 0.94},
	"ravie":                          {1.42, 1.56},
	"rockwell condensed":             {0.90, 1.02},
	"rockwell extra bold":            {1.22, 1.32},
	"rockwell":                       {1.16, 1.18},
	"rod":                            {0.93, 1.05},
	"sakkal majalla":                 {0.90, 1.02},
	"sarasa gothic":                  {1.10, 1.13},
	"segoe print":                    {1.16, 1.27},
	"segoe script":                   {1.10, 1.22},
	"segoe ui black":                 {1.12, 1.14},
	"segoe ui emoji":                 {1.08, 1.11},
	"segoe ui historic":              {1.08, 1.11},
	"segoe ui semibold":              {1.12, 1.14},
	"segoe ui semilight":             {1.08, 1.11},
	"segoe ui symbol":                {1.08, 1.11},
	"segoe ui":                       {1.08, 1.11},
	"shonar bangla":                  {1, 1.12},
	"showcard gothic":                {1.32, 1.42},
	"shruti":                         {0.97, 1.10},
	"simfang":                        {1.10, 0.90},
	"simhei":                         {1.10, 0.90},
	"simkai":                         {1.10, 0.90},
	"simsun-extb":                    {1.10, 0.90},
	"simsun":                         {1.10, 0.90},
	"sitka banner":                   {0.95, 1.08},
	"sitka display":                  {1, 1.12},
	"sitka heading":                  {1.03, 1.16},
	"sitka small":                    {1.07, 1.20},
	"sitka subheading":               {1.03, 1.16},
	"snap itc":                       {1.32, 1.42},
	"source han sans":                {1.10, 1.13},
	"source han serif":               {1.10, 1.13},
	"stcaiyun":                       {1.10, 0.90},
	"stencil":                        {1.16, 1.27},
	"stfangsong":                     {1.10, 0.90},
	"stheiti":                        {1.10, 0.90},
	"sthupo":                         {1.10, 0.90},
	"stkaiti":                        {1.10, 0.90},
	"stliti":                         {1.10, 0.90},
	...
	"stxingkai":                      {1.10, 0.90},
	"stxinwei":                       {1.10, 0.90},
	"stzhongsong":                    {1.10, 0.90},
	"sylfaen":                        {1.03, 1.16},
	"tahoma":                         {1.07, 1.10},
	"tempus sans itc":                {1.14, 1.26},
	"times new roman":                {1.01, 1.20},
	"traditional arabic":             {0.85, 0.96},
	"trebuchet ms":                   {1.10, 1.06},
	"tunga":                          {0.95, 1.08},
	"tw cen mt condensed extra bold": {0.88, 1.02},
	"tw cen mt condensed":            {0.86, 0.98},
	"tw cen mt":                      {0.98, 1.12},
	"ud digi kyokasho n-b":           {1.10, 0.90},
	"ud digi kyokasho n-r":           {1.10, 0.90},
	"ud digi kyokasho nk-b":          {1.10, 0.90},
	"ud digi kyokasho nk-r":          {1.10, 0.90},
	"ud デジタル 教科書体 n":                 {1.10, 0.90},
	"ud デジタル 教科書体 nk":                {1.10, 0.90},
	"urdu typesetting":               {0.82, 0.94},
	"utsaah":                         {0.93, 1.05},
	"vani":                           {0.97, 1.10},
	"verdana":                        {1.23, 1.24},
	"vijaya":                         {0.90, 1.02},
	"vivaldi":                        {0.76, 0.87},
	"vladimir script":                {0.82, 0.94},
	"vrinda":                         {0.95, 1.08},
	"wide latin":                     {1.68, 1.85},
	"youyuan":                        {1.10, 0.90},
	"yu gothic light":                {1.03, 1.14},
	"yu gothic medium":               {1.12, 1.21},
	"yu gothic ui light":             {1.03, 1.14},
	"yu gothic ui semibold":          {1.12, 1.21},
	"yu gothic ui semilight":         {1.03, 1.14},
	"yu gothic ui":                   {1.12, 1.21},
	"yu gothic":                      {1.12, 1.21},
	"yu mincho":                      {1.08, 1.28},
	"굴림":                             {0.99, 1.11},
	"굴림체":                            {1.10, 0.90},
	...
	"宋体":                             {1.10, 0.90},
	"幼圆":                             {1.10, 0.90},
	"微软正黑体 light":                    {1.10, 1.15},
	"微软正黑体":                          {1.16, 1.19},
	"微软雅黑 light":                     {1.10, 1.15},
	"微软雅黑":                           {1.18, 1.20},
	"思源宋体":                           {1.10, 1.13},
	"思源黑体":                           {1.10, 1.13},
	"新宋体":                            {1.10, 0.90},
	...
	"楷体":                             {1.10, 0.90},
	"標楷體":                            {1.10, 0.90},
	"游ゴシック light":                    {1.03, 1.14},
	"游ゴシック medium":                   {1.12, 1.21},
	"游ゴシック ui":                       {1.12, 1.21},
	"游ゴシック":                          {1.12, 1.21},
	"游明朝":                            {1.08, 1.28},
	"等线":                             {1.05, 1.08},

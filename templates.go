...
var (
	//go:embed templates/DocpropsApp.xml
	templateDocpropsApp string

	//go:embed templates/ContentTypes.xml
	templateContentTypes string

	//go:embed templates/Workbook.xml
	templateWorkbook string

	//go:embed templates/Styles.xml
	templateStyles string

	//go:embed templates/Sheet.xml
	templateSheet string

	//go:embed templates/WorkbookRels.xml
	templateWorkbookRels string

	//go:embed templates/DocpropsCore.xml
	templateDocpropsCore string

	//go:embed templates/Rels.xml
	templateRels string

	//go:embed templates/Theme.xml

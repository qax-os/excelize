...
var supportedFontWidthFactors = map[string][]float64{
	...
	"agency fb":                      {0.69, 0.86},
	"aptos":                          {1.03, 1.37},
	"arial black":                    {1.35, 1.59},
	"arial narrow":                   {0.88, 1.2},
	"arial rounded mt bold":          {1.07, 1.57},
	"arial unicode ms":               {1.07, 1.42},
	"arial":                          {1.07, 1.42},
	"bahnschrift":                    {1.10, 1.3},
	"baskerville old face":           {0.98, 1.56},
	"batang":                         {0.99, 1.31},
	"batangche":                      {1.10, 1.1},
	"bauhaus 93":                     {1.10, 1.43},
	"bell mt":                        {0.95, 1.33},
	"berlin sans fb":                 {1.03, 1.36},
	"bernard mt condensed":           {0.94, 1.24},
	"blackadder itc":                 {0.76, 2.12},
	"bodoni mt condensed":            {0.82, 1.17},
	"bodoni mt poster compressed":    {0.72, 1.06},
	"bodoni mt":                      {1.06, 1.47},
	"book antiqua":                   {1.12, 1.44},
	"bookman old style":              {1.14, 1.66},
	"broadway":                       {1.35, 1.75},
	"brush script mt":                {0.82, 1.34},
	"calibri light":                  {0.98, 1.19},
	"calisto mt":                     {1.03, 1.42},
	"cambria math":                   {1.07, 1.28},
	"cambria":                        {1.07, 1.28},
	"candara light":                  {1.02, 1.35},
	"cascadia mono extralight":       {1.42, 1.49},
	"castellar":                      {1.38, 1.58},
	"centaur":                        {0.93, 1.3},
	"century gothic":                 {1.19, 1.36},
	"century schoolbook":             {1.10, 1.63},
	"century":                        {1.09, 1.52},
	"chiller":                        {0.90, 1.22},
	"colonna mt":                     {0.87, 1.4},
	"comic sans ms":                  {1.14, 1.46},
	"consolas":                       {1.21, 1.19},
	"cooper black":                   {1.28, 1.6},
	"copperplate gothic bold":        {1.32, 1.62},
	"copperplate gothic light":       {1.26, 1.58},
	"corbel light":                   {0.98, 1.26},
	"corbel":                         {1.03, 1.3},
	"courier new":                    {1.31, 1.28},
	"curlz mt":                       {1.16, 1.47},
	"david":                          {0.95, 1.28},
	"dengxian light":                 {1.02, 1.26},
	"dengxian":                       {1.05, 1.28},
	"dfkai-sb":                       {1.10, 1.1},
	"dotum":                          {0.99, 1.31},
	"dotumche":                       {1.10, 1.1},
	"dubai":                          {1, 1.32},
	"ebrima":                         {1.08, 1.31},
	"edwardian script itc":           {0.82, 1.78},
	"elephant":                       {1.24, 1.86},
	"engravers mt":                   {1.79, 1.99},
	"eras bold itc":                  {1.14, 1.45},
	"eras demi itc":                  {1.10, 1.42},
	"eras light itc":                 {1.07, 1.4},
	"eras medium itc":                {1.10, 1.42},
	"fangsong_gb2312":                {1.10, 1.36},
	"felix titling":                  {1.20, 1.55},
	"footlight mt light":             {1.03, 1.37},
	"forte":                          {0.93, 1.25},
	"franklin gothic demi cond":      {0.88, 1.2},
	"franklin gothic demi":           {1.08, 1.42},
	"franklin gothic heavy":          {1.16, 1.45},
	"franklin gothic medium":         {1.08, 1.42},
	"freestyle script":               {0.87, 1.18},
	"french script mt":               {0.82, 1.54},
	"fzshuti":                        {1.10, 1.36},
	"fzyaoti":                        {1.10, 1.36},
	"gabriola":                       {0.95, 1.28},
	"garamond":                       {0.96, 1.39},
	"georgia":                        {1.09, 1.43},
	"gigi":                           {0.95, 1.28},
	"gill sans mt condensed":         {0.85, 1.18},
	"gill sans mt":                   {1.03, 1.36},
	"gill sans ultra bold":           {1.30, 1.6},
	"gloucester mt extra condensed":  {0.72, 1.02},
	"goudy old style":                {0.98, 1.37},
	"goudy stout":                    {2.36, 2.8},
	"gulim":                          {0.99, 1.31},
	"gulimche":                       {1.10, 1.36},
	"gungsuh":                        {0.99, 1.31},
	"gungsuhche":                     {1.10, 1.36},
	"haettenschweiler":               {0.72, 1.02},
	"harlow solid italic":            {0.90, 1.82},
	"harrington":                     {1.07, 1.4},
	"helvetica neue":                 {1.10, 1.42},
	"helvetica":                      {1.07, 1.42},
	"high tower text":                {0.87, 1.53},
	"impact":                         {1.01, 1.12},
	"informal roman":                 {1.07, 1.4},
	"ink free":                       {1.02, 1.33},
	"javanese text":                  {1.10, 1.42},
	"jokerman":                       {1.16, 1.67},
	"juice itc":                      {0.82, 1.14},
	"kaiti_gb2312":                   {1.10, 1.1},
	"kaiti":                          {1.10, 1.1},
	"kartika":                        {1, 1.32},
	"kokila":                         {0.97, 1.3},
	"kristen itc":                    {1.10, 1.42},
	"kunstler script":                {0.72, 1.72},
	"latha":                          {0.95, 1.28},
	"leelawadee ui":                  {1.08, 1.31},
	"leelawadee":                     {1.03, 1.36},
	"lisu":                           {1.10, 1.42},
	"lucida bright":                  {1.18, 1.47},
	"lucida calligraphy":             {1.18, 1.67},
	"lucida console":                 {1.32, 1.29},
	"lucida fax":                     {1.14, 1.45},
	"lucida handwriting":             {1.34, 1.67},
	"lucida sans typewriter":         {1.32, 1.29},
	"lucida sans unicode":            {1.18, 1.47},
	"lucida sans":                    {1.18, 1.47},
	"lxgw wenkai":                    {1.10, 1.6},
	"magneto":                        {1.18, 1.98},
	"maiandra gd":                    {1.10, 1.42},
	"malgun gothic semilight":        {1.07, 1.51},
	"malgun gothic":                  {1.10, 1.33},
	"mangal":                         {1.10, 1.42},
	"meiryo":                         {1.19, 1.42},
	"microsoft himalaya":             {0.85, 0.96},
	"microsoft jhenghei light":       {1.10, 1.3},
	"microsoft jhenghei ui":          {1.16, 1.39},
	"microsoft jhenghei":             {1.16, 1.39},
	"microsoft new tai lue":          {1.03, 1.38},
	"microsoft phagspa":              {1, 1.3},
	"microsoft sans serif":           {1.07, 1.4},
	"microsoft tai le":               {1, 1.3},
	"microsoft uighur":               {0.90, 1.1},
	"microsoft yahei light":          {1.10, 1.3},
	"microsoft yahei ui":             {1.18, 1.3},
	"microsoft yahei":                {1.18, 1.3},
	"microsoft yi baiti":             {1, 1.12},
	"mingliu_hkscs":                  {1.10, 1.2},
	"mingliu-extb":                   {1.10, 1.2},
	"mingliu":                        {1.10, 1.2},
	"mistral":                        {0.87, 0.9},
	"modern no. 20":                  {0.90, 1.42},
	"mongolian baiti":                {0.95, 1.38},
	"monotype corsiva":               {0.85, 1.26},
	"ms gothic":                      {1.10, 1.1},
	"ms pgothic":                     {0.99, 1.31},
	"ms reference sans serif":        {1.18, 1.47},
	"ms sans serif":                  {1.10, 1.42},
	"narkisim":                       {0.93, 1.25},
	"niagara engraved":               {0.48, 0.58},
	"niagara solid":                  {0.48, 0.58},
	"nirmala ui semilight":           {1.01, 1.32},
	"nirmala ui":                     {1.03, 1.36},
	"noto sans cjk":                  {1.10, 1.33},
	"noto serif cjk":                 {1.10, 1.33},
	"nsimsun":                        {1.10, 1.1},
	"nyala":                          {1, 1.32},
	"onyx":                           {0.68, 0.98},
	"palace script mt":               {0.72, 1.22},
	"palatino linotype":              {1.12, 1.44},
	"papyrus":                        {1.10, 1.82},
	"parchment":                      {0.74, 1.84},
	"perpetua titling mt":            {1.23, 1.52},
	"perpetua":                       {0.95, 1.33},
	"playbill":                       {0.72, 1.02},
	"poor richard":                   {0.97, 1.36},
	"pristina":                       {0.87, 1.18},
	"rage italic":                    {0.82, 1.14},
	"ravie":                          {1.42, 1.86},
	"rockwell condensed":             {0.90, 1.22},
	"rockwell extra bold":            {1.22, 1.72},
	"rockwell":                       {1.16, 1.48},
	"rod":                            {0.93, 1.25},
	"sakkal majalla":                 {0.90, 1.22},
	"sarasa gothic":                  {1.10, 1.33},
	"segoe print":                    {1.16, 1.47},
	"segoe script":                   {1.10, 1.42},
	"segoe ui black":                 {1.12, 1.34},
	"segoe ui emoji":                 {1.08, 1.31},
	"segoe ui historic":              {1.08, 1.31},
	"segoe ui semibold":              {1.12, 1.34},
	"segoe ui semilight":             {1.08, 1.31},
	"segoe ui symbol":                {1.08, 1.31},
	"segoe ui":                       {1.08, 1.31},
	"shonar bangla":                  {1, 1.32},
	"showcard gothic":                {1.5, 1.92},
	"shruti":                         {0.97, 1.3},
	"simfang":                        {1.10, 1.1},
	"simhei":                         {1.10, 1.1},
	"simkai":                         {1.10, 1.1},
	"simsun-extb":                    {1.10, 1.1},
	"simsun":                         {1.10, 1.1},
	"sitka banner":                   {0.95, 1.28},
	"sitka display":                  {1, 1.32},
	"sitka heading":                  {1.03, 1.36},
	"sitka small":                    {1.07, 1.4},
	"sitka subheading":               {1.03, 1.36},
	"snap itc":                       {1.32, 1.62},
	"source han sans":                {1.10, 1.33},
	"source han serif":               {1.10, 1.33},
	"stcaiyun":                       {1.10, 1.1},
	"stencil":                        {1.16, 1.47},
	"stfangsong":                     {1.10, 1.9},
	"stheiti":                        {1.10, 1.1},
	...
	"stxingkai":                      {1.10, 1.36},
	"stxinwei":                       {1.10, 1.36},
	"stzhongsong":                    {1.10, 1.66},
	"sylfaen":                        {1.03, 1.36},
	"tahoma":                         {1.07, 1.3},
	"tempus sans itc":                {1.14, 1.46},
	"times new roman":                {1.01, 1.4},
	"traditional arabic":             {0.85, 1.56},
	"trebuchet ms":                   {1.10, 1.26},
	"tunga":                          {0.95, 1.28},
	"tw cen mt condensed extra bold": {0.88, 1.22},
	"tw cen mt condensed":            {0.86, 1.18},
	"tw cen mt":                      {0.98, 1.32},
	"ud digi kyokasho n-b":           {1.10, 1.36},
	"ud digi kyokasho n-r":           {1.10, 1.36},
	"ud digi kyokasho nk-b":          {1.10, 1.36},
	"ud digi kyokasho nk-r":          {1.10, 1.36},
	"ud デジタル 教科書体 n":                 {1.10, 1.36},
	"ud デジタル 教科書体 nk":                {1.10, 1.36},
	"urdu typesetting":               {0.82, 1.34},
	"utsaah":                         {0.93, 1.25},
	"vani":                           {0.97, 1.3},
	"verdana":                        {1.23, 1.44},
	"vijaya":                         {0.90, 1.22},
	"vivaldi":                        {0.76, 2.12},
	"vladimir script":                {0.82, 1.54},
	"vrinda":                         {0.95, 1.28},
	"wide latin":                     {1.68, 2.65},
	"youyuan":                        {1.10, 1.36},
	"yu gothic light":                {1.03, 1.34},
	"yu gothic medium":               {1.12, 1.41},
	"yu gothic ui light":             {1.03, 1.24},
	"yu gothic ui semibold":          {1.12, 1.31},
	"yu gothic ui semilight":         {1.03, 1.24},
	"yu gothic ui":                   {1.12, 1.41},
	"yu gothic":                      {1.12, 1.41},
	"yu mincho":                      {1.08, 1.48},
	"굴림":                             {0.99, 1.11},
	"굴림체":                            {1.10, 0.9},
